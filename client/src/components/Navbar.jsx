...
const Navbar = () => {
    ...
    const { user, setUser, navigate, setShowUserLogin,getCartCount,SearchQuery,
                ...
                {user ? (
                    <>
                        <div className="relative group ">
                            ...
                            <ul onClick={() => {
                                navigate("/my-Orders");
                            }} className="hidden  group-hover:block  absolute top-10 right-0  bg-white shadow-md rounded-md border-gray-200 py-2 w-30  text-sm ">
                                <li className="py-1.5 cursor-pointer">My Orders</li>
                                <li onClick={() => setUser(null)} className="py-1.5 cursor-pointer">Logout</li>

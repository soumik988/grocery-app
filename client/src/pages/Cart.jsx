...
const Cart = () => {
  ...
  const [address, setAddress] = useState([]);  // Start with empty array
  const [showAddress, setShowAddress] = useState(false);
  const [selectedAddress, setSelectedAddress] = useState(null); // Start null
  ...
  return (
    <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
      ...
      {/* Right Section */}
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70 relative">
        ...
        <div className="mb-6">
          ...
          <div className="relative flex justify-between items-start mt-2">
            ...
            {showAddress && (
              <div
                className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10"
